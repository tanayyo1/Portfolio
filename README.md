...
- 📝 **Blog Ready** - Built-in blog functionality with MDX support
- 🎯 **SEO Optimized** - Meta tags and structured data for better visibility
- 🛠️ **Easy to Customize** - Single configuration file for all your data
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/tanayyo1/Portfolio.git
   cd Portfolio
   ```
